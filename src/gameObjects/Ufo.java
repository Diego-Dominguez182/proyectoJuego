...
public class Ufo extends MovingObject {
    ...
    private final ArrayList<Vector2D> path; // Ruta que sigue el UFO

    private int index; // Índice actual en la ruta

    private boolean following; // Indica si el UFO está siguiendo la ruta

    private long fireRate; // Tiempo de recarga entre disparos

    private final Sound shoot; // Sonido de disparo del UFO
