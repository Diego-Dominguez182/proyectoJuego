...
public class XMLParser {
    ...
    // Lee los datos de puntuación desde un archivo XML y los devuelve en una lista
            ...
            while (eventReader.hasNext()) {
                ...
                if (event.isStartElement()) {
                    ...
                    if (start.getName().getLocalPart().equals(Constants.PLAYER)) {
                        ...
                        Objects.requireNonNull(data).setDate(event.asCharacters().getData());
                    } else if (start.getName().getLocalPart().equals(Constants.SCORE)) {
                        event = eventReader.nextEvent();
                        Objects.requireNonNull(data).setScore(Integer.parseInt(event.asCharacters().getData()));
                    }
                }
    ...
    // Escribe los datos de puntuación en un archivo XML
