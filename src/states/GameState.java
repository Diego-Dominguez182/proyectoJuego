...
public class GameState extends State{
	...
	private void spawnPowerUp() {
		...
		switch (p) {
			...
			case SCORE_X2 -> action = new Action() {
				@Override
				public void doAction() {
			...
			case FASTER_FIRE -> action = new Action() {
				@Override
				public void doAction() {
					player.setFastFire();
					messages.add(new Message(
			...
			case SCORE_STACK -> action = new Action() {
				@Override
				public void doAction() {
					score += 1000;
					messages.add(new Message(
			...
			case DOUBLE_GUN -> action = new Action() {
				@Override
				public void doAction() {
					player.setDoubleGun();
					messages.add(new Message(
